...
class PlutoFeatureBuilder(AbstractFeatureBuilder):
    def __init__(
        ...
        self.radius = radius
        self.history_horizon = history_horizon#2
        self.future_horizon = future_horizon#8
        self.history_samples = int(self.history_horizon / sample_interval)#20
        self.future_samples = int(self.future_horizon / sample_interval)#80
    ...
    def get_features_from_scenario(
        ...
        scenario_log_name=scenario.log_name
        scenario_name=scenario.scenario_name
        
        
        print(f"Scenario token is {scenario_token}")
        print(f"Scenario log name is {scenario_log_name}")
    ...
    def _build_feature(
        ...
        if present_idx < 0:
            ...
            print("present_idx: 目前的idx是", present_idx)#其实取得就是101里面的最后一个
